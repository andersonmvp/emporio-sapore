	...
	if ( ! function_exists( 'kirki_installer_register' ) ) {
		...
		function kirki_installer_register( $wp_customize ) {
			...
			$wp_customize->add_section( 'kirki_installer', array(
				'title'       => '',
				'description' => sprintf(esc_html__( 'If you wish to customize the look & feel of %sWoo Floating Cart%s, please install the required %sXT Customizer Kit%s plugin.', 'woo-floating-cart' ), '<strong>', '</strong>', '<strong>', '</strong>'),
				'priority'    => -10,
