...
class Woo_Floating_Cart {
	...
	public function license() {
		...
		if(!empty($this->license) && $this->license instanceof Woo_Floating_Cart_License) {
			return $this->license;
		}
		
		$refreshLicense = woofc_is_action('refresh-license');
		$this->license = new Woo_Floating_Cart_License($this->plugin_slug, $refreshLicense);	
	...
	private function define_admin_hooks() {
		...
		if(is_admin()) {
			...
			// Check for updates
			if(!defined('WOOFC_LITE')) {
				new Woo_Floating_Cart_Update($this);
			}	
	...
	public function customizer_init() {
		...
		new Woo_Floating_Cart_Customizer($this);
	}
	...
	public function customizer_controls( $wp_customize ) {
		...
		new Woo_Floating_Cart_Customizer_Controls($wp_customize);
