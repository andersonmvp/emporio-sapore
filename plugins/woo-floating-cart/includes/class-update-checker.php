...
if ( !class_exists('Woo_Floating_Cart_Update_Checker', false) ):
 ...
 * @access public
 */
class Woo_Floating_Cart_Update_Checker {
	...
	public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = ''){
		...
		$this->upgraderStatus = new Woo_Floating_Cart_Upgrader_Status();
	 ...
	 * @return Woo_Floating_Cart_Update_Scheduler
	 */
	protected function createScheduler($checkPeriod) {
		return new Woo_Floating_Cart_Update_Scheduler($this, $checkPeriod);
	}
	 ...
	 * @return Woo_Floating_Cart_Plugin_Info
	 */
	public function requestInfo($queryArgs = array()){
		...
		if ( !is_wp_error($status) ){
			$pluginInfo = Woo_Floating_Cart_Plugin_Info::fromJson($result['body']);
			if ( $pluginInfo !== null ) {
	 ...
	 *
	 * @return Woo_Floating_Cart_Plugin_Update An instance of PluginUpdate, or NULL when no updates are available.
	 */
	public function requestUpdate(){
		...
		$update = Woo_Floating_Cart_Plugin_Update::fromPluginInfo($pluginInfo);
	 ...
	 *
	 * @return Woo_Floating_Cart_Plugin_Update|null
	 */
	...
	public function getUpdateState() {
		...
		if ( isset($state, $state->update) && is_object($state->update) ) {
			$state->update = Woo_Floating_Cart_Plugin_Update::fromObject($state->update);
		}
		return $state;
	}
	...
	private function setUpdateState($state) {
		if ( isset($state->update) && is_object($state->update) && method_exists($state->update, 'toStdClass') ) {
			$update = $state->update; /** @var Woo_Floating_Cart_Plugin_Update $update */
	 ...
	 * @param Woo_Floating_Cart_Plugin_Update $updateToAdd
	 * @return StdClass
	 */
...
if ( !class_exists('Woo_Floating_Cart_Plugin_Info', false) ):
 ...
 * @access public
 */
class Woo_Floating_Cart_Plugin_Info {
	 ...
	 * @return Woo_Floating_Cart_Plugin_Info|null New instance of PluginInfo, or NULL on error.
	 */
...
if ( !class_exists('Woo_Floating_Cart_Plugin_Update', false) ):
 ...
 * @access public
 */
class Woo_Floating_Cart_Plugin_Update {
	public $id = 0;
	public $slug;
	public $version;
	public $homepage;
	...
	public static function fromJson($json){
		...
		$pluginInfo = Woo_Floating_Cart_Plugin_Info::fromJson($json);
		if ( $pluginInfo != null ) {
	 ...
	 * 
	 * @param Woo_Floating_Cart_Plugin_Info $info
	 * @return Woo_Floating_Cart_Plugin_Update
	 */
	 ...
	 * another object.
	 *  
	 * @param StdClass|Woo_Floating_Cart_Plugin_Info|Woo_Floating_Cart_Plugin_Update $object The source object.
	 * @return Woo_Floating_Cart_Plugin_Update The new copy.
	 */
...
if ( !class_exists('Woo_Floating_Cart_Update_Scheduler', false) ):
 ...
 * @version 3.0
 */
class Woo_Floating_Cart_Update_Scheduler {
	public $checkPeriod = 12; //How often to check for updates (in hours).
	public $throttleRedundantChecks = false; //Check less often if we already know that an update is available.
	public $throttledCheckPeriod = 72;

	/**
	 * @var Woo_Floating_Cart_Update_Checker
	 */
	 ...
	 *
	 * @param Woo_Floating_Cart_Update_Checker $updateChecker
...
if ( !class_exists('Woo_Floating_Cart_Upgrader_Status', false) ):
 ...
 */
class Woo_Floating_Cart_Upgrader_Status {
...
if ( !class_exists('Woo_Floating_Cart_Update_Factory', false) ):
 ...
 * versions by calling {@link Woo_Floating_Cart_Update_Factory::addVersion()}.
 *
 ...
 * want to instantiate one of them anyway, you can use {@link Woo_Floating_Cart_Update_Factory::getLatestClassVersion()}
 * to get the class name and then create it with <code>new $class(...)</code>.
 */
class Woo_Floating_Cart_Update_Factory {
	 ...
	 * @return Woo_Floating_Cart_Update_Checker
	 */
...
Woo_Floating_Cart_Update_Factory::addVersion('PluginUpdateChecker', 'Woo_Floating_Cart_Update_Checker', '3.1');
Woo_Floating_Cart_Update_Factory::addVersion('PluginUpdate', 'Woo_Floating_Cart_Plugin_Update', '3.1');
Woo_Floating_Cart_Update_Factory::addVersion('PluginInfo', 'Woo_Floating_Cart_Plugin_Info', '3.1');
