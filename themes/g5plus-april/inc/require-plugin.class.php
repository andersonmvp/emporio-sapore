        ...
        public function init()
        {
            ...
            $plugins = array(
                array(
                    ...
                    'source'             => get_template_directory() . '/inc/plugins/april-framework-v2.7.zip', // The plugin source
                ...
                array(
                    ...
                    'source'             => get_template_directory() . '/inc/plugins/revslider_5.4.7.zip', // The plugin source
                    'required'           => true, // If false, the plugin is only 'recommended' instead of required
                ...
                array(
                    ...
                    'source'             => get_template_directory() . '/inc/plugins/js_composer_5.4.7.zip', // The plugin source
                    'required'           => true, // If false, the plugin is only 'recommended' instead of required
                    'version'            => '5.4.7', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
                    'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
                    'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
